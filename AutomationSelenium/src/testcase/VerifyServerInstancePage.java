...
public class VerifyServerInstancePage {
	...
	public static void main(String[] args) {
		...
		Servers oS = new Servers(logger);
		ServerInstance oSI = new ServerInstance(logger);
		...
		try {
			...
			dl.login(driver);
			oS.openServerPage(driver,logger);
			oSI.openServerInstancePage(driver);
			oSI.verifyServerInstanceData(driver);
